...
import app.PaperBox.ActivityMain;
import app.PaperBox.ActivityPlaceDetail;
import app.PaperBox.R;
import app.PaperBox.adapter.AdapterPlaceGrid;
import app.PaperBox.connection.RestAdapter;
import app.PaperBox.connection.callbacks.CallbackListPlace;
import app.PaperBox.data.AppConfig;
import app.PaperBox.data.Constant;
import app.PaperBox.data.DatabaseHandler;
import app.PaperBox.data.SharedPref;
import app.PaperBox.data.ThisApplication;
import app.PaperBox.model.Place;
import app.PaperBox.utils.Tools;
import app.PaperBox.widget.SpacingItemDecoration;
